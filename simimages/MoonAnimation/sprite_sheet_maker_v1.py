...
# --- Parameters ---
FRAME_PREFIX = 'final_'
HEIGHTS = [720, 400, 200]  # Output heights for sprite sheets

# --- Collect frame filenames, skipping the first 25 ---
...
def frame_num(filename):
    # Extract the last integer before .png
    return int(filename.split('_')[-1].split('.')[0])
all_frames = sorted(all_frames, key=frame_num)
frames = all_frames[25:]  # skip first 25
